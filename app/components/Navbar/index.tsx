...
const PrimarySearchAppBar = ({ user }: IProps) => {
  ...
  const renderMobileMenu = (
    ...
    >
      <MenuItem onClick={ user ? handleProfileMenuOpen : () => console.log('should change route here')}>
        ...
        <Toolbar className={classes.navbar}>
          ...
          <div className={classes.sectionDesktop}>
            <IconButton
              ...
              aria-haspopup="true"
              onClick={user ? handleProfileMenuOpen : () => console.log('should changee route here')}
              color="inherit"
            >
               { !user ?
