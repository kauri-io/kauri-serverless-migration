...
const Editor = ({ withTabs, withToolbar, compact, openModalAction, closeModalAction }) => {
    ...
    const format = (type: string, url?: string, text?: string) => {
        ...
        const input = document.getElementById('editor-text-area') as HTMLTextAreaElement
        if (input) {
    ...
    return (
        <div className={classes.editorContainer}>
            ...
            {tab === 3 && <>
                <Button variant='text' color='primary'>Import from Wordpress</Button>
                <Button variant='text' color='primary'>Import from Medium</Button>
            </>}
        </div>
    )
}
