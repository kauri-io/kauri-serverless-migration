...
> = ({ title, description, linkComponent, resourceType, id, userId, tags, username, avatar, ownerResourceType}) => {
    ...
    <ContentSection>
      <ResourceDetailsContainer>
        ...
        {linkComponent(
          <React.Fragment>
            <Title2>
            {String(title && title.length < 30 ? title : title && `${title.substring(0, 27)}...`)}
            </Title2>
            <BodyCard>
