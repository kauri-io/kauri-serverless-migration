...
export interface getCommunity_getCommunity_approved_ArticleDTO_contributors_articles {
  __typename: "ResponsePage_ArticleDTO";
  /**
   * Total amount of elements.
   */
...
export interface getCommunity_getCommunity_approved_ArticleDTO_contributors_collections {
  __typename: "ResponsePage_CollectionDTO";
  /**
   * Total amount of elements.
   */
...
export interface getCommunity_getCommunity_approved_ArticleDTO_contributors_links {
  __typename: "ResponsePage_ExternalLinkDTO";
  /**
   * Total amount of elements.
   */
...
export interface getCommunity_getCommunity_approved_ArticleDTO_contributors_communities_community {
  __typename: "CommunityDTO";
  /**
   * Community ID
   */
...
export interface getCommunity_getCommunity_approved_ArticleDTO_contributors_communities {
  __typename: "MemberRoleCommunityDTO";
  /**
   * Community
   */
  community: getCommunity_getCommunity_approved_ArticleDTO_contributors_communities_community;
}
...
export interface getCommunity_getCommunity_approved_ArticleDTO_contributors {
   ...
   * This operation can only be performed by logged user
   */
  articles: getCommunity_getCommunity_approved_ArticleDTO_contributors_articles;
  /**
   * Returns a page of CollectionDTO owned by this PublicUserDTO.
   * This operation can only be performed by logged user
   */
  collections: getCommunity_getCommunity_approved_ArticleDTO_contributors_collections;
  /**
   * Returns a page of ExternalLinkDTO owned by this PublicUserDTO.
   * This operation can only be performed by logged user
   */
  links: getCommunity_getCommunity_approved_ArticleDTO_contributors_links;
  /**
   * Get communities the user is member of mapped by role
   */
  communities: (getCommunity_getCommunity_approved_ArticleDTO_contributors_communities | null)[];
}
...
export interface getCommunity_getCommunity_approved_ExternalLinkDTO_owner_ArticleDTO {
  __typename: "ArticleDTO" | "CollectionDTO" | "CommunityInvitationDTO" | "CommunityMemberDTO" | "ExternalLinkDTO" | "CommentDTO" | "SeriesDTO" | "UserDTO" | "TemplateDTO" | "SearchResultDTO" | "CuratedListDTO";
}

export interface getCommunity_getCommunity_approved_ExternalLinkDTO_owner_PublicUserDTO_resourceIdentifier {
  __typename: "ResourceIdentifier";
  /**
   * Resource ID
   */
...
export interface getCommunity_getCommunity_approved_ExternalLinkDTO_owner_PublicUserDTO {
  __typename: "PublicUserDTO";
  /**
   * User ID (Ethereum account address)
   */
   ...
   */
  avatar: string | null;
  resourceIdentifier: getCommunity_getCommunity_approved_ExternalLinkDTO_owner_PublicUserDTO_resourceIdentifier | null;
}

export interface getCommunity_getCommunity_approved_ExternalLinkDTO_owner_CommunityDTO_resourceIdentifier {
  __typename: "ResourceIdentifier";
  /**
   * Resource ID
   */
...
export interface getCommunity_getCommunity_approved_ExternalLinkDTO_owner_CommunityDTO {
  __typename: "CommunityDTO";
  /**
   * Community ID
   */
   ...
   */
  avatar: string | null;
  resourceIdentifier: getCommunity_getCommunity_approved_ExternalLinkDTO_owner_CommunityDTO_resourceIdentifier | null;
}

export type getCommunity_getCommunity_approved_ExternalLinkDTO_owner = getCommunity_getCommunity_approved_ExternalLinkDTO_owner_ArticleDTO | getCommunity_getCommunity_approved_ExternalLinkDTO_owner_PublicUserDTO | getCommunity_getCommunity_approved_ExternalLinkDTO_owner_CommunityDTO;
...
export interface getCommunity_getCommunity_approved_ExternalLinkDTO_authorName {
  __typename: "ExternalLinkField_String";
  /**
   * The field value
   */
...
export interface getCommunity_getCommunity_approved_ExternalLinkDTO_comments_content_author {
  __typename: "PublicUserDTO";
  /**
   * User ID (Ethereum account address)
   */
...
export interface getCommunity_getCommunity_approved_ExternalLinkDTO_comments_content {
  __typename: "CommentDTO";
  /**
   * Comment author (full profile)
   */
  author: getCommunity_getCommunity_approved_ExternalLinkDTO_comments_content_author;
  /**
   * Date the comment was published
   */
  posted: any;
...
export interface getCommunity_getCommunity_approved_ExternalLinkDTO_comments {
  __typename: "ResponsePage_CommentDTO";
  /**
   * Returns the page content.
   */
  content: (getCommunity_getCommunity_approved_ExternalLinkDTO_comments_content | null)[];
  /**
   * Number of total pages.
   */
  totalPages: number;
...
export interface getCommunity_getCommunity_approved_ExternalLinkDTO_voteResult {
  __typename: "VoteResultDTO";
  /**
   * Vote sum: Sum of the vote (-1,+1,+1=+1)
   */
...
export interface getCommunity_getCommunity_approved_ExternalLinkDTO {
   ...
   * load the external link owner (user or community resource type)
   */
  owner: getCommunity_getCommunity_approved_ExternalLinkDTO_owner | null;
  /**
   * External link submitter (full profile)
   */
   ...
   * The link content author
   */
  authorName: getCommunity_getCommunity_approved_ExternalLinkDTO_authorName;
  /**
   * Get a paginated list of comments for this external link
   */
  comments: getCommunity_getCommunity_approved_ExternalLinkDTO_comments;
  /**
   * The link content author
   */
  authorSocial: any | null;
   ...
   * Get vote result for the external link
   */
  voteResult: getCommunity_getCommunity_approved_ExternalLinkDTO_voteResult;
}
...
export interface getCommunity_getCommunity_approved_CollectionDTO_sections_resources_ArticleDTO_associatedNfts {
  __typename: "NftTokenDTO";
  tokenType: string | null;
  contractAddress: string | null;
  name: string | null;
...
export interface getCommunity_getCommunity_approved_CollectionDTO_sections_resources_ArticleDTO_resourceIdentifier {
  __typename: "ResourceIdentifier";
  /**
   * Resource ID
   */
...
export interface getCommunity_getCommunity_approved_CollectionDTO_sections_resources_ArticleDTO_contributors_articles {
  __typename: "ResponsePage_ArticleDTO";
  /**
   * Total amount of elements.
   */
...
export interface getCommunity_getCommunity_approved_CollectionDTO_sections_resources_ArticleDTO_contributors_collections {
  __typename: "ResponsePage_CollectionDTO";
  /**
   * Total amount of elements.
   */
...
export interface getCommunity_getCommunity_approved_CollectionDTO_sections_resources_ArticleDTO_contributors_links {
  __typename: "ResponsePage_ExternalLinkDTO";
  /**
   * Total amount of elements.
   */
...
export interface getCommunity_getCommunity_approved_CollectionDTO_sections_resources_ArticleDTO_contributors_communities_community {
  __typename: "CommunityDTO";
  /**
   * Community ID
   */
...
export interface getCommunity_getCommunity_approved_CollectionDTO_sections_resources_ArticleDTO_contributors_communities {
  __typename: "MemberRoleCommunityDTO";
  /**
   * Community
   */
  community: getCommunity_getCommunity_approved_CollectionDTO_sections_resources_ArticleDTO_contributors_communities_community;
}

export interface getCommunity_getCommunity_approved_CollectionDTO_sections_resources_ArticleDTO_contributors {
  __typename: "PublicUserDTO";
  /**
   * User ID (Ethereum account address)
   */
   ...
   * This operation can only be performed by logged user
   */
  articles: getCommunity_getCommunity_approved_CollectionDTO_sections_resources_ArticleDTO_contributors_articles;
  /**
   * Returns a page of CollectionDTO owned by this PublicUserDTO.
   * This operation can only be performed by logged user
   */
  collections: getCommunity_getCommunity_approved_CollectionDTO_sections_resources_ArticleDTO_contributors_collections;
  /**
   * Returns a page of ExternalLinkDTO owned by this PublicUserDTO.
   * This operation can only be performed by logged user
   */
  links: getCommunity_getCommunity_approved_CollectionDTO_sections_resources_ArticleDTO_contributors_links;
  /**
   * Get communities the user is member of mapped by role
   */
  communities: (getCommunity_getCommunity_approved_CollectionDTO_sections_resources_ArticleDTO_contributors_communities | null)[];
}

export interface getCommunity_getCommunity_approved_CollectionDTO_sections_resources_ArticleDTO_voteResult {
  __typename: "VoteResultDTO";
  /**
   * Vote sum: Sum of the vote (-1,+1,+1=+1)
   */
...
export interface getCommunity_getCommunity_approved_CollectionDTO_sections_resources_ArticleDTO_author {
  __typename: "PublicUserDTO";
  /**
   * User ID (Ethereum account address)
   */
...
export interface getCommunity_getCommunity_approved_CollectionDTO_sections_resources_ArticleDTO_owner_ArticleDTO {
  __typename: "ArticleDTO" | "CollectionDTO" | "CommunityInvitationDTO" | "CommunityMemberDTO" | "ExternalLinkDTO" | "CommentDTO" | "SeriesDTO" | "UserDTO" | "TemplateDTO" | "SearchResultDTO" | "CuratedListDTO";
}

export interface getCommunity_getCommunity_approved_CollectionDTO_sections_resources_ArticleDTO_owner_PublicUserDTO_resourceIdentifier {
  __typename: "ResourceIdentifier";
  /**
   * Resource ID
   */
...
export interface getCommunity_getCommunity_approved_CollectionDTO_sections_resources_ArticleDTO_owner_PublicUserDTO {
  __typename: "PublicUserDTO";
  /**
   * User ID (Ethereum account address)
   */
   ...
   */
  avatar: string | null;
  resourceIdentifier: getCommunity_getCommunity_approved_CollectionDTO_sections_resources_ArticleDTO_owner_PublicUserDTO_resourceIdentifier | null;
}

export interface getCommunity_getCommunity_approved_CollectionDTO_sections_resources_ArticleDTO_owner_CommunityDTO_resourceIdentifier {
  __typename: "ResourceIdentifier";
  /**
   * Resource ID
   */
...
export interface getCommunity_getCommunity_approved_CollectionDTO_sections_resources_ArticleDTO_owner_CommunityDTO {
  __typename: "CommunityDTO";
  /**
   * Community ID
   */
   ...
   */
  avatar: string | null;
  resourceIdentifier: getCommunity_getCommunity_approved_CollectionDTO_sections_resources_ArticleDTO_owner_CommunityDTO_resourceIdentifier | null;
}

export type getCommunity_getCommunity_approved_CollectionDTO_sections_resources_ArticleDTO_owner = getCommunity_getCommunity_approved_CollectionDTO_sections_resources_ArticleDTO_owner_ArticleDTO | getCommunity_getCommunity_approved_CollectionDTO_sections_resources_ArticleDTO_owner_PublicUserDTO | getCommunity_getCommunity_approved_CollectionDTO_sections_resources_ArticleDTO_owner_CommunityDTO;

export interface getCommunity_getCommunity_approved_CollectionDTO_sections_resources_ArticleDTO_comments_content_author {
  __typename: "PublicUserDTO";
  /**
   * User ID (Ethereum account address)
   */
...
export interface getCommunity_getCommunity_approved_CollectionDTO_sections_resources_ArticleDTO_comments_content {
  __typename: "CommentDTO";
  /**
   * Comment author (full profile)
   */
  author: getCommunity_getCommunity_approved_CollectionDTO_sections_resources_ArticleDTO_comments_content_author;
  /**
   * Date the comment was published
   */
  posted: any;
...
export interface getCommunity_getCommunity_approved_CollectionDTO_sections_resources_ArticleDTO_comments {
  __typename: "ResponsePage_CommentDTO";
  /**
   * Returns the page content.
   */
  content: (getCommunity_getCommunity_approved_CollectionDTO_sections_resources_ArticleDTO_comments_content | null)[];
  /**
   * Number of total pages.
   */
  totalPages: number;
...
export interface getCommunity_getCommunity_approved_CollectionDTO_sections_resources_ArticleDTO {
   ...
   * NFTs associated with this article
   */
  associatedNfts: (getCommunity_getCommunity_approved_CollectionDTO_sections_resources_ArticleDTO_associatedNfts | null)[] | null;
  resourceIdentifier: getCommunity_getCommunity_approved_CollectionDTO_sections_resources_ArticleDTO_resourceIdentifier | null;
  /**
   * Returns a list of contributors (PublicUserDTO) for this ArticleDTO
   * This operation can only be performed by logged user
   */
  contributors: (getCommunity_getCommunity_approved_CollectionDTO_sections_resources_ArticleDTO_contributors | null)[];
  /**
   * Check if the article was already read by the current user
   */
  isRead: boolean;
   ...
   * Get vote result for the article
   */
  voteResult: getCommunity_getCommunity_approved_CollectionDTO_sections_resources_ArticleDTO_voteResult;
  /**
   * Article author (full profile)
   */
  author: getCommunity_getCommunity_approved_CollectionDTO_sections_resources_ArticleDTO_author;
  /**
   * load the article owner (user or community resource type)
   */
  owner: getCommunity_getCommunity_approved_CollectionDTO_sections_resources_ArticleDTO_owner | null;
  /**
   * Get a paginated list of comments for this article
   */
  comments: getCommunity_getCommunity_approved_CollectionDTO_sections_resources_ArticleDTO_comments;
  /**
   * The comment describing this version update of the article
   */
  updateComment: string | null;
...
export interface getCommunity_getCommunity_approved_CollectionDTO_sections_resources_ExternalLinkDTO_resourceIdentifier {
  __typename: "ResourceIdentifier";
  /**
   * Resource type
   */
...
export interface getCommunity_getCommunity_approved_CollectionDTO_sections_resources_ExternalLinkDTO_owner_ArticleDTO {
  __typename: "ArticleDTO" | "CollectionDTO" | "CommunityInvitationDTO" | "CommunityMemberDTO" | "ExternalLinkDTO" | "CommentDTO" | "SeriesDTO" | "UserDTO" | "TemplateDTO" | "SearchResultDTO" | "CuratedListDTO";
}

export interface getCommunity_getCommunity_approved_CollectionDTO_sections_resources_ExternalLinkDTO_owner_PublicUserDTO_resourceIdentifier {
  __typename: "ResourceIdentifier";
  /**
   * Resource ID
   */
...
export interface getCommunity_getCommunity_approved_CollectionDTO_sections_resources_ExternalLinkDTO_owner_PublicUserDTO {
  __typename: "PublicUserDTO";
  /**
   * User ID (Ethereum account address)
   */
   ...
   */
  avatar: string | null;
  resourceIdentifier: getCommunity_getCommunity_approved_CollectionDTO_sections_resources_ExternalLinkDTO_owner_PublicUserDTO_resourceIdentifier | null;
}

export interface getCommunity_getCommunity_approved_CollectionDTO_sections_resources_ExternalLinkDTO_owner_CommunityDTO_resourceIdentifier {
  __typename: "ResourceIdentifier";
  /**
   * Resource ID
   */
...
export interface getCommunity_getCommunity_approved_CollectionDTO_sections_resources_ExternalLinkDTO_owner_CommunityDTO {
  __typename: "CommunityDTO";
  /**
   * Community ID
   */
   ...
   */
  avatar: string | null;
  resourceIdentifier: getCommunity_getCommunity_approved_CollectionDTO_sections_resources_ExternalLinkDTO_owner_CommunityDTO_resourceIdentifier | null;
}

export type getCommunity_getCommunity_approved_CollectionDTO_sections_resources_ExternalLinkDTO_owner = getCommunity_getCommunity_approved_CollectionDTO_sections_resources_ExternalLinkDTO_owner_ArticleDTO | getCommunity_getCommunity_approved_CollectionDTO_sections_resources_ExternalLinkDTO_owner_PublicUserDTO | getCommunity_getCommunity_approved_CollectionDTO_sections_resources_ExternalLinkDTO_owner_CommunityDTO;

export interface getCommunity_getCommunity_approved_CollectionDTO_sections_resources_ExternalLinkDTO_submitter {
  __typename: "PublicUserDTO";
  /**
   * User ID (Ethereum account address)
   */
...
export interface getCommunity_getCommunity_approved_CollectionDTO_sections_resources_ExternalLinkDTO_url {
  __typename: "ExternalLinkField_String";
  /**
   * The field value
   */
...
export interface getCommunity_getCommunity_approved_CollectionDTO_sections_resources_ExternalLinkDTO_linkTitle {
  __typename: "ExternalLinkField_String";
  /**
   * The field value
   */
...
export interface getCommunity_getCommunity_approved_CollectionDTO_sections_resources_ExternalLinkDTO_linkDescription {
  __typename: "ExternalLinkField_String";
  /**
   * The field value
   */
...
export interface getCommunity_getCommunity_approved_CollectionDTO_sections_resources_ExternalLinkDTO_summary {
  __typename: "ExternalLinkField_String";
  /**
   * The field value
   */
...
export interface getCommunity_getCommunity_approved_CollectionDTO_sections_resources_ExternalLinkDTO_authorName {
  __typename: "ExternalLinkField_String";
  /**
   * The field value
   */
...
export interface getCommunity_getCommunity_approved_CollectionDTO_sections_resources_ExternalLinkDTO_comments_content_author {
  __typename: "PublicUserDTO";
  /**
   * User ID (Ethereum account address)
   */
...
export interface getCommunity_getCommunity_approved_CollectionDTO_sections_resources_ExternalLinkDTO_comments_content {
  __typename: "CommentDTO";
  /**
   * Comment author (full profile)
   */
  author: getCommunity_getCommunity_approved_CollectionDTO_sections_resources_ExternalLinkDTO_comments_content_author;
  /**
   * Date the comment was published
   */
  posted: any;
...
export interface getCommunity_getCommunity_approved_CollectionDTO_sections_resources_ExternalLinkDTO_comments {
  __typename: "ResponsePage_CommentDTO";
  /**
   * Returns the page content.
   */
  content: (getCommunity_getCommunity_approved_CollectionDTO_sections_resources_ExternalLinkDTO_comments_content | null)[];
  /**
   * Number of total pages.
   */
  totalPages: number;
...
export interface getCommunity_getCommunity_approved_CollectionDTO_sections_resources_ExternalLinkDTO_voteResult {
  __typename: "VoteResultDTO";
  /**
   * Vote sum: Sum of the vote (-1,+1,+1=+1)
   */
...
export interface getCommunity_getCommunity_approved_CollectionDTO_sections_resources_ExternalLinkDTO {
  __typename: "ExternalLinkDTO";
  /**
   * External link ID
   */
  id: string;
  resourceIdentifier: getCommunity_getCommunity_approved_CollectionDTO_sections_resources_ExternalLinkDTO_resourceIdentifier | null;
  /**
   * The date that this external link was created
   */
  dateCreated: any;
   ...
   * load the external link owner (user or community resource type)
   */
  owner: getCommunity_getCommunity_approved_CollectionDTO_sections_resources_ExternalLinkDTO_owner | null;
  /**
   * External link submitter (full profile)
   */
  submitter: getCommunity_getCommunity_approved_CollectionDTO_sections_resources_ExternalLinkDTO_submitter;
  /**
   * The link url
   */
  url: getCommunity_getCommunity_approved_CollectionDTO_sections_resources_ExternalLinkDTO_url;
  /**
   * The link title
   */
  linkTitle: getCommunity_getCommunity_approved_CollectionDTO_sections_resources_ExternalLinkDTO_linkTitle;
  /**
   * The description of the link, obtained via metadata
   */
  linkDescription: getCommunity_getCommunity_approved_CollectionDTO_sections_resources_ExternalLinkDTO_linkDescription | null;
  /**
   * The user input summary of the link
   */
  summary: getCommunity_getCommunity_approved_CollectionDTO_sections_resources_ExternalLinkDTO_summary | null;
  /**
   * Link attributes
   */
  linkAttributes: any | null;
   ...
   * The link content author
   */
  authorName: getCommunity_getCommunity_approved_CollectionDTO_sections_resources_ExternalLinkDTO_authorName;
  /**
   * Get a paginated list of comments for this external link
   */
  comments: getCommunity_getCommunity_approved_CollectionDTO_sections_resources_ExternalLinkDTO_comments;
  /**
   * The link content author
   */
  authorSocial: any | null;
   ...
   * Get vote result for the external link
   */
  voteResult: getCommunity_getCommunity_approved_CollectionDTO_sections_resources_ExternalLinkDTO_voteResult;
}

export type getCommunity_getCommunity_approved_CollectionDTO_sections_resources = getCommunity_getCommunity_approved_CollectionDTO_sections_resources_PublicUserDTO | getCommunity_getCommunity_approved_CollectionDTO_sections_resources_ArticleDTO | getCommunity_getCommunity_approved_CollectionDTO_sections_resources_ExternalLinkDTO;
...
export interface getCommunity_getCommunity_approved_CollectionDTO_sections {
   ...
   * load the resources within this section
   */
  resources: (getCommunity_getCommunity_approved_CollectionDTO_sections_resources | null)[];
}
...
export interface getCommunity_getCommunity_pending_ArticleDTO_contributors_articles {
  __typename: "ResponsePage_ArticleDTO";
  /**
   * Total amount of elements.
   */
...
export interface getCommunity_getCommunity_pending_ArticleDTO_contributors_collections {
  __typename: "ResponsePage_CollectionDTO";
  /**
   * Total amount of elements.
   */
...
export interface getCommunity_getCommunity_pending_ArticleDTO_contributors_links {
  __typename: "ResponsePage_ExternalLinkDTO";
  /**
   * Total amount of elements.
   */
...
export interface getCommunity_getCommunity_pending_ArticleDTO_contributors_communities_community {
  __typename: "CommunityDTO";
  /**
   * Community ID
   */
...
export interface getCommunity_getCommunity_pending_ArticleDTO_contributors_communities {
  __typename: "MemberRoleCommunityDTO";
  /**
   * Community
   */
  community: getCommunity_getCommunity_pending_ArticleDTO_contributors_communities_community;
}
...
export interface getCommunity_getCommunity_pending_ArticleDTO_contributors {
   ...
   * This operation can only be performed by logged user
   */
  articles: getCommunity_getCommunity_pending_ArticleDTO_contributors_articles;
  /**
   * Returns a page of CollectionDTO owned by this PublicUserDTO.
   * This operation can only be performed by logged user
   */
  collections: getCommunity_getCommunity_pending_ArticleDTO_contributors_collections;
  /**
   * Returns a page of ExternalLinkDTO owned by this PublicUserDTO.
   * This operation can only be performed by logged user
   */
  links: getCommunity_getCommunity_pending_ArticleDTO_contributors_links;
  /**
   * Get communities the user is member of mapped by role
   */
  communities: (getCommunity_getCommunity_pending_ArticleDTO_contributors_communities | null)[];
}
...
export interface getCommunity_getCommunity_pending_ExternalLinkDTO_owner_ArticleDTO {
  __typename: "ArticleDTO" | "CollectionDTO" | "CommunityInvitationDTO" | "CommunityMemberDTO" | "ExternalLinkDTO" | "CommentDTO" | "SeriesDTO" | "UserDTO" | "TemplateDTO" | "SearchResultDTO" | "CuratedListDTO";
}

export interface getCommunity_getCommunity_pending_ExternalLinkDTO_owner_PublicUserDTO_resourceIdentifier {
  __typename: "ResourceIdentifier";
  /**
   * Resource ID
   */
...
export interface getCommunity_getCommunity_pending_ExternalLinkDTO_owner_PublicUserDTO {
  __typename: "PublicUserDTO";
  /**
   * User ID (Ethereum account address)
   */
   ...
   */
  avatar: string | null;
  resourceIdentifier: getCommunity_getCommunity_pending_ExternalLinkDTO_owner_PublicUserDTO_resourceIdentifier | null;
}

export interface getCommunity_getCommunity_pending_ExternalLinkDTO_owner_CommunityDTO_resourceIdentifier {
  __typename: "ResourceIdentifier";
  /**
   * Resource ID
   */
...
export interface getCommunity_getCommunity_pending_ExternalLinkDTO_owner_CommunityDTO {
  __typename: "CommunityDTO";
  /**
   * Community ID
   */
   ...
   */
  avatar: string | null;
  resourceIdentifier: getCommunity_getCommunity_pending_ExternalLinkDTO_owner_CommunityDTO_resourceIdentifier | null;
}

export type getCommunity_getCommunity_pending_ExternalLinkDTO_owner = getCommunity_getCommunity_pending_ExternalLinkDTO_owner_ArticleDTO | getCommunity_getCommunity_pending_ExternalLinkDTO_owner_PublicUserDTO | getCommunity_getCommunity_pending_ExternalLinkDTO_owner_CommunityDTO;
...
export interface getCommunity_getCommunity_pending_ExternalLinkDTO_authorName {
  __typename: "ExternalLinkField_String";
  /**
   * The field value
   */
...
export interface getCommunity_getCommunity_pending_ExternalLinkDTO_comments_content_author {
  __typename: "PublicUserDTO";
  /**
   * User ID (Ethereum account address)
   */
...
export interface getCommunity_getCommunity_pending_ExternalLinkDTO_comments_content {
  __typename: "CommentDTO";
  /**
   * Comment author (full profile)
   */
  author: getCommunity_getCommunity_pending_ExternalLinkDTO_comments_content_author;
  /**
   * Date the comment was published
   */
  posted: any;
...
export interface getCommunity_getCommunity_pending_ExternalLinkDTO_comments {
  __typename: "ResponsePage_CommentDTO";
  /**
   * Returns the page content.
   */
  content: (getCommunity_getCommunity_pending_ExternalLinkDTO_comments_content | null)[];
  /**
   * Number of total pages.
   */
  totalPages: number;
...
export interface getCommunity_getCommunity_pending_ExternalLinkDTO_voteResult {
  __typename: "VoteResultDTO";
  /**
   * Vote sum: Sum of the vote (-1,+1,+1=+1)
   */
...
export interface getCommunity_getCommunity_pending_ExternalLinkDTO {
   ...
   * load the external link owner (user or community resource type)
   */
  owner: getCommunity_getCommunity_pending_ExternalLinkDTO_owner | null;
  /**
   * External link submitter (full profile)
   */
   ...
   * The link content author
   */
  authorName: getCommunity_getCommunity_pending_ExternalLinkDTO_authorName;
  /**
   * Get a paginated list of comments for this external link
   */
  comments: getCommunity_getCommunity_pending_ExternalLinkDTO_comments;
  /**
   * The link content author
   */
  authorSocial: any | null;
   ...
   * Get vote result for the external link
   */
  voteResult: getCommunity_getCommunity_pending_ExternalLinkDTO_voteResult;
}
...
export interface getCommunity_getCommunity_pending_CollectionDTO_sections_resources_ArticleDTO_associatedNfts {
  __typename: "NftTokenDTO";
  tokenType: string | null;
  contractAddress: string | null;
  name: string | null;
...
export interface getCommunity_getCommunity_pending_CollectionDTO_sections_resources_ArticleDTO_resourceIdentifier {
  __typename: "ResourceIdentifier";
  /**
   * Resource ID
   */
...
export interface getCommunity_getCommunity_pending_CollectionDTO_sections_resources_ArticleDTO_contributors_articles {
  __typename: "ResponsePage_ArticleDTO";
  /**
   * Total amount of elements.
   */
...
export interface getCommunity_getCommunity_pending_CollectionDTO_sections_resources_ArticleDTO_contributors_collections {
  __typename: "ResponsePage_CollectionDTO";
  /**
   * Total amount of elements.
   */
...
export interface getCommunity_getCommunity_pending_CollectionDTO_sections_resources_ArticleDTO_contributors_links {
  __typename: "ResponsePage_ExternalLinkDTO";
  /**
   * Total amount of elements.
   */
...
export interface getCommunity_getCommunity_pending_CollectionDTO_sections_resources_ArticleDTO_contributors_communities_community {
  __typename: "CommunityDTO";
  /**
   * Community ID
   */
...
export interface getCommunity_getCommunity_pending_CollectionDTO_sections_resources_ArticleDTO_contributors_communities {
  __typename: "MemberRoleCommunityDTO";
  /**
   * Community
   */
  community: getCommunity_getCommunity_pending_CollectionDTO_sections_resources_ArticleDTO_contributors_communities_community;
}

export interface getCommunity_getCommunity_pending_CollectionDTO_sections_resources_ArticleDTO_contributors {
  __typename: "PublicUserDTO";
  /**
   * User ID (Ethereum account address)
   */
   ...
   * This operation can only be performed by logged user
   */
  articles: getCommunity_getCommunity_pending_CollectionDTO_sections_resources_ArticleDTO_contributors_articles;
  /**
   * Returns a page of CollectionDTO owned by this PublicUserDTO.
   * This operation can only be performed by logged user
   */
  collections: getCommunity_getCommunity_pending_CollectionDTO_sections_resources_ArticleDTO_contributors_collections;
  /**
   * Returns a page of ExternalLinkDTO owned by this PublicUserDTO.
   * This operation can only be performed by logged user
   */
  links: getCommunity_getCommunity_pending_CollectionDTO_sections_resources_ArticleDTO_contributors_links;
  /**
   * Get communities the user is member of mapped by role
   */
  communities: (getCommunity_getCommunity_pending_CollectionDTO_sections_resources_ArticleDTO_contributors_communities | null)[];
}

export interface getCommunity_getCommunity_pending_CollectionDTO_sections_resources_ArticleDTO_voteResult {
  __typename: "VoteResultDTO";
  /**
   * Vote sum: Sum of the vote (-1,+1,+1=+1)
   */
...
export interface getCommunity_getCommunity_pending_CollectionDTO_sections_resources_ArticleDTO_author {
  __typename: "PublicUserDTO";
  /**
   * User ID (Ethereum account address)
   */
...
export interface getCommunity_getCommunity_pending_CollectionDTO_sections_resources_ArticleDTO_owner_ArticleDTO {
  __typename: "ArticleDTO" | "CollectionDTO" | "CommunityInvitationDTO" | "CommunityMemberDTO" | "ExternalLinkDTO" | "CommentDTO" | "SeriesDTO" | "UserDTO" | "TemplateDTO" | "SearchResultDTO" | "CuratedListDTO";
}

export interface getCommunity_getCommunity_pending_CollectionDTO_sections_resources_ArticleDTO_owner_PublicUserDTO_resourceIdentifier {
  __typename: "ResourceIdentifier";
  /**
   * Resource ID
   */
...
export interface getCommunity_getCommunity_pending_CollectionDTO_sections_resources_ArticleDTO_owner_PublicUserDTO {
  __typename: "PublicUserDTO";
  /**
   * User ID (Ethereum account address)
   */
   ...
   */
  avatar: string | null;
  resourceIdentifier: getCommunity_getCommunity_pending_CollectionDTO_sections_resources_ArticleDTO_owner_PublicUserDTO_resourceIdentifier | null;
}

export interface getCommunity_getCommunity_pending_CollectionDTO_sections_resources_ArticleDTO_owner_CommunityDTO_resourceIdentifier {
  __typename: "ResourceIdentifier";
  /**
   * Resource ID
   */
...
export interface getCommunity_getCommunity_pending_CollectionDTO_sections_resources_ArticleDTO_owner_CommunityDTO {
  __typename: "CommunityDTO";
  /**
   * Community ID
   */
   ...
   */
  avatar: string | null;
  resourceIdentifier: getCommunity_getCommunity_pending_CollectionDTO_sections_resources_ArticleDTO_owner_CommunityDTO_resourceIdentifier | null;
}

export type getCommunity_getCommunity_pending_CollectionDTO_sections_resources_ArticleDTO_owner = getCommunity_getCommunity_pending_CollectionDTO_sections_resources_ArticleDTO_owner_ArticleDTO | getCommunity_getCommunity_pending_CollectionDTO_sections_resources_ArticleDTO_owner_PublicUserDTO | getCommunity_getCommunity_pending_CollectionDTO_sections_resources_ArticleDTO_owner_CommunityDTO;

export interface getCommunity_getCommunity_pending_CollectionDTO_sections_resources_ArticleDTO_comments_content_author {
  __typename: "PublicUserDTO";
  /**
   * User ID (Ethereum account address)
   */
...
export interface getCommunity_getCommunity_pending_CollectionDTO_sections_resources_ArticleDTO_comments_content {
  __typename: "CommentDTO";
  /**
   * Comment author (full profile)
   */
  author: getCommunity_getCommunity_pending_CollectionDTO_sections_resources_ArticleDTO_comments_content_author;
  /**
   * Date the comment was published
   */
  posted: any;
...
export interface getCommunity_getCommunity_pending_CollectionDTO_sections_resources_ArticleDTO_comments {
  __typename: "ResponsePage_CommentDTO";
  /**
   * Returns the page content.
   */
  content: (getCommunity_getCommunity_pending_CollectionDTO_sections_resources_ArticleDTO_comments_content | null)[];
  /**
   * Number of total pages.
   */
  totalPages: number;
...
export interface getCommunity_getCommunity_pending_CollectionDTO_sections_resources_ArticleDTO {
   ...
   * NFTs associated with this article
   */
  associatedNfts: (getCommunity_getCommunity_pending_CollectionDTO_sections_resources_ArticleDTO_associatedNfts | null)[] | null;
  resourceIdentifier: getCommunity_getCommunity_pending_CollectionDTO_sections_resources_ArticleDTO_resourceIdentifier | null;
  /**
   * Returns a list of contributors (PublicUserDTO) for this ArticleDTO
   * This operation can only be performed by logged user
   */
  contributors: (getCommunity_getCommunity_pending_CollectionDTO_sections_resources_ArticleDTO_contributors | null)[];
  /**
   * Check if the article was already read by the current user
   */
  isRead: boolean;
   ...
   * Get vote result for the article
   */
  voteResult: getCommunity_getCommunity_pending_CollectionDTO_sections_resources_ArticleDTO_voteResult;
  /**
   * Article author (full profile)
   */
  author: getCommunity_getCommunity_pending_CollectionDTO_sections_resources_ArticleDTO_author;
  /**
   * load the article owner (user or community resource type)
   */
  owner: getCommunity_getCommunity_pending_CollectionDTO_sections_resources_ArticleDTO_owner | null;
  /**
   * Get a paginated list of comments for this article
   */
  comments: getCommunity_getCommunity_pending_CollectionDTO_sections_resources_ArticleDTO_comments;
  /**
   * The comment describing this version update of the article
   */
  updateComment: string | null;
...
export interface getCommunity_getCommunity_pending_CollectionDTO_sections_resources_ExternalLinkDTO_resourceIdentifier {
  __typename: "ResourceIdentifier";
  /**
   * Resource type
   */
...
export interface getCommunity_getCommunity_pending_CollectionDTO_sections_resources_ExternalLinkDTO_owner_ArticleDTO {
  __typename: "ArticleDTO" | "CollectionDTO" | "CommunityInvitationDTO" | "CommunityMemberDTO" | "ExternalLinkDTO" | "CommentDTO" | "SeriesDTO" | "UserDTO" | "TemplateDTO" | "SearchResultDTO" | "CuratedListDTO";
}

export interface getCommunity_getCommunity_pending_CollectionDTO_sections_resources_ExternalLinkDTO_owner_PublicUserDTO_resourceIdentifier {
  __typename: "ResourceIdentifier";
  /**
   * Resource ID
   */
...
export interface getCommunity_getCommunity_pending_CollectionDTO_sections_resources_ExternalLinkDTO_owner_PublicUserDTO {
  __typename: "PublicUserDTO";
  /**
   * User ID (Ethereum account address)
   */
   ...
   */
  avatar: string | null;
  resourceIdentifier: getCommunity_getCommunity_pending_CollectionDTO_sections_resources_ExternalLinkDTO_owner_PublicUserDTO_resourceIdentifier | null;
}

export interface getCommunity_getCommunity_pending_CollectionDTO_sections_resources_ExternalLinkDTO_owner_CommunityDTO_resourceIdentifier {
  __typename: "ResourceIdentifier";
  /**
   * Resource ID
   */
...
export interface getCommunity_getCommunity_pending_CollectionDTO_sections_resources_ExternalLinkDTO_owner_CommunityDTO {
  __typename: "CommunityDTO";
  /**
   * Community ID
   */
   ...
   */
  avatar: string | null;
  resourceIdentifier: getCommunity_getCommunity_pending_CollectionDTO_sections_resources_ExternalLinkDTO_owner_CommunityDTO_resourceIdentifier | null;
}

export type getCommunity_getCommunity_pending_CollectionDTO_sections_resources_ExternalLinkDTO_owner = getCommunity_getCommunity_pending_CollectionDTO_sections_resources_ExternalLinkDTO_owner_ArticleDTO | getCommunity_getCommunity_pending_CollectionDTO_sections_resources_ExternalLinkDTO_owner_PublicUserDTO | getCommunity_getCommunity_pending_CollectionDTO_sections_resources_ExternalLinkDTO_owner_CommunityDTO;

export interface getCommunity_getCommunity_pending_CollectionDTO_sections_resources_ExternalLinkDTO_submitter {
  __typename: "PublicUserDTO";
  /**
   * User ID (Ethereum account address)
   */
...
export interface getCommunity_getCommunity_pending_CollectionDTO_sections_resources_ExternalLinkDTO_url {
  __typename: "ExternalLinkField_String";
  /**
   * The field value
   */
...
export interface getCommunity_getCommunity_pending_CollectionDTO_sections_resources_ExternalLinkDTO_linkTitle {
  __typename: "ExternalLinkField_String";
  /**
   * The field value
   */
...
export interface getCommunity_getCommunity_pending_CollectionDTO_sections_resources_ExternalLinkDTO_linkDescription {
  __typename: "ExternalLinkField_String";
  /**
   * The field value
   */
...
export interface getCommunity_getCommunity_pending_CollectionDTO_sections_resources_ExternalLinkDTO_summary {
  __typename: "ExternalLinkField_String";
  /**
   * The field value
   */
...
export interface getCommunity_getCommunity_pending_CollectionDTO_sections_resources_ExternalLinkDTO_authorName {
  __typename: "ExternalLinkField_String";
  /**
   * The field value
   */
...
export interface getCommunity_getCommunity_pending_CollectionDTO_sections_resources_ExternalLinkDTO_comments_content_author {
  __typename: "PublicUserDTO";
  /**
   * User ID (Ethereum account address)
   */
...
export interface getCommunity_getCommunity_pending_CollectionDTO_sections_resources_ExternalLinkDTO_comments_content {
  __typename: "CommentDTO";
  /**
   * Comment author (full profile)
   */
  author: getCommunity_getCommunity_pending_CollectionDTO_sections_resources_ExternalLinkDTO_comments_content_author;
  /**
   * Date the comment was published
   */
  posted: any;
...
export interface getCommunity_getCommunity_pending_CollectionDTO_sections_resources_ExternalLinkDTO_comments {
  __typename: "ResponsePage_CommentDTO";
  /**
   * Returns the page content.
   */
  content: (getCommunity_getCommunity_pending_CollectionDTO_sections_resources_ExternalLinkDTO_comments_content | null)[];
  /**
   * Number of total pages.
   */
  totalPages: number;
...
export interface getCommunity_getCommunity_pending_CollectionDTO_sections_resources_ExternalLinkDTO_voteResult {
  __typename: "VoteResultDTO";
  /**
   * Vote sum: Sum of the vote (-1,+1,+1=+1)
   */
...
export interface getCommunity_getCommunity_pending_CollectionDTO_sections_resources_ExternalLinkDTO {
  __typename: "ExternalLinkDTO";
  /**
   * External link ID
   */
  id: string;
  resourceIdentifier: getCommunity_getCommunity_pending_CollectionDTO_sections_resources_ExternalLinkDTO_resourceIdentifier | null;
  /**
   * The date that this external link was created
   */
  dateCreated: any;
   ...
   * load the external link owner (user or community resource type)
   */
  owner: getCommunity_getCommunity_pending_CollectionDTO_sections_resources_ExternalLinkDTO_owner | null;
  /**
   * External link submitter (full profile)
   */
  submitter: getCommunity_getCommunity_pending_CollectionDTO_sections_resources_ExternalLinkDTO_submitter;
  /**
   * The link url
   */
  url: getCommunity_getCommunity_pending_CollectionDTO_sections_resources_ExternalLinkDTO_url;
  /**
   * The link title
   */
  linkTitle: getCommunity_getCommunity_pending_CollectionDTO_sections_resources_ExternalLinkDTO_linkTitle;
  /**
   * The description of the link, obtained via metadata
   */
  linkDescription: getCommunity_getCommunity_pending_CollectionDTO_sections_resources_ExternalLinkDTO_linkDescription | null;
  /**
   * The user input summary of the link
   */
  summary: getCommunity_getCommunity_pending_CollectionDTO_sections_resources_ExternalLinkDTO_summary | null;
  /**
   * Link attributes
   */
  linkAttributes: any | null;
   ...
   * The link content author
   */
  authorName: getCommunity_getCommunity_pending_CollectionDTO_sections_resources_ExternalLinkDTO_authorName;
  /**
   * Get a paginated list of comments for this external link
   */
  comments: getCommunity_getCommunity_pending_CollectionDTO_sections_resources_ExternalLinkDTO_comments;
  /**
   * The link content author
   */
  authorSocial: any | null;
   ...
   * Get vote result for the external link
   */
  voteResult: getCommunity_getCommunity_pending_CollectionDTO_sections_resources_ExternalLinkDTO_voteResult;
}

export type getCommunity_getCommunity_pending_CollectionDTO_sections_resources = getCommunity_getCommunity_pending_CollectionDTO_sections_resources_PublicUserDTO | getCommunity_getCommunity_pending_CollectionDTO_sections_resources_ArticleDTO | getCommunity_getCommunity_pending_CollectionDTO_sections_resources_ExternalLinkDTO;
...
export interface getCommunity_getCommunity_pending_CollectionDTO_sections {
   ...
   * load the resources within this section
   */
  resources: (getCommunity_getCommunity_pending_CollectionDTO_sections_resources | null)[];
}
