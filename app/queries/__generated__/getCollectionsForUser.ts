...
export interface getCollectionsForUser_searchCollections_content_sections_resources_ArticleDTO {
   ...
   */
  ownerId: getCollectionsForUser_searchCollections_content_sections_resources_ArticleDTO_ownerId;
  /**
   * Date created
   */
  dateCreated: any;
...
export interface getCollectionsForUser_searchCollections_content_sections_resources_ExternalLinkDTO {
   ...
   * The link owner
   */
  ownerId: getCollectionsForUser_searchCollections_content_sections_resources_ExternalLinkDTO_ownerId;
  /**
