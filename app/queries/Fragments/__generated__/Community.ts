...
export interface Community_homepage_resources_ArticleDTO_contributors_articles {
...
export interface Community_homepage_resources_ArticleDTO_contributors_collections {
...
export interface Community_homepage_resources_ArticleDTO_contributors_links {
...
export interface Community_homepage_resources_ArticleDTO_contributors_communities_community {
...
export interface Community_homepage_resources_ArticleDTO_contributors_communities {
  __typename: "MemberRoleCommunityDTO";
  /**
   * Community
   */
  community: Community_homepage_resources_ArticleDTO_contributors_communities_community;
}
...
export interface Community_homepage_resources_ArticleDTO_contributors {
   ...
   */
  articles: Community_homepage_resources_ArticleDTO_contributors_articles;
  /**
   * Returns a page of CollectionDTO owned by this PublicUserDTO.
   * This operation can only be performed by logged user
   */
  collections: Community_homepage_resources_ArticleDTO_contributors_collections;
  /**
   * Returns a page of ExternalLinkDTO owned by this PublicUserDTO.
   * This operation can only be performed by logged user
   */
  links: Community_homepage_resources_ArticleDTO_contributors_links;
  /**
   * Get communities the user is member of mapped by role
   */
  communities: (Community_homepage_resources_ArticleDTO_contributors_communities | null)[];
}
...
export interface Community_homepage_resources_ArticleDTO_comments_content_author {
  __typename: "PublicUserDTO";
  /**
   * User ID (Ethereum account address)
   */
...
export interface Community_homepage_resources_ArticleDTO_comments_content {
...
export interface Community_homepage_resources_ArticleDTO_comments {
   ...
   */
  content: (Community_homepage_resources_ArticleDTO_comments_content | null)[];
  /**
...
export interface Community_homepage_resources_ArticleDTO {
   ...
   */
  associatedNfts: (Community_homepage_resources_ArticleDTO_associatedNfts | null)[] | null;
   ...
   * This operation can only be performed by logged user
   */
  contributors: (Community_homepage_resources_ArticleDTO_contributors | null)[];
  /**
   ...
   */
  comments: Community_homepage_resources_ArticleDTO_comments;
  /**
...
export interface Community_homepage_resources_ExternalLinkDTO_resourceIdentifier {
  __typename: "ResourceIdentifier";
  /**
   * Resource type
   */
...
export interface Community_homepage_resources_ExternalLinkDTO_owner_PublicUserDTO {
  __typename: "PublicUserDTO";
  /**
   * User ID (Ethereum account address)
   */
   ...
   */
  avatar: string | null;
  resourceIdentifier: Community_homepage_resources_ExternalLinkDTO_owner_PublicUserDTO_resourceIdentifier | null;
}

export interface Community_homepage_resources_ExternalLinkDTO_owner_CommunityDTO_resourceIdentifier {
  __typename: "ResourceIdentifier";
  /**
   * Resource ID
   */
...
export interface Community_homepage_resources_ExternalLinkDTO_owner_CommunityDTO {
  __typename: "CommunityDTO";
  /**
   * Community ID
   */
   ...
   */
  avatar: string | null;
  resourceIdentifier: Community_homepage_resources_ExternalLinkDTO_owner_CommunityDTO_resourceIdentifier | null;
}

export type Community_homepage_resources_ExternalLinkDTO_owner = Community_homepage_resources_ExternalLinkDTO_owner_ArticleDTO | Community_homepage_resources_ExternalLinkDTO_owner_PublicUserDTO | Community_homepage_resources_ExternalLinkDTO_owner_CommunityDTO;

export interface Community_homepage_resources_ExternalLinkDTO_submitter {
  __typename: "PublicUserDTO";
  /**
   * User ID (Ethereum account address)
   */
...
export interface Community_homepage_resources_ExternalLinkDTO_url {
...
export interface Community_homepage_resources_ExternalLinkDTO_linkTitle {
  __typename: "ExternalLinkField_String";
  /**
   * The field value
   */
...
export interface Community_homepage_resources_ExternalLinkDTO_linkDescription {
  __typename: "ExternalLinkField_String";
  /**
   * The field value
   */
...
export interface Community_homepage_resources_ExternalLinkDTO_summary {
  __typename: "ExternalLinkField_String";
  /**
   * The field value
   */
...
export interface Community_homepage_resources_ExternalLinkDTO_authorName {
  __typename: "ExternalLinkField_String";
  /**
   * The field value
   */
...
export interface Community_homepage_resources_ExternalLinkDTO_comments_content_author {
  __typename: "PublicUserDTO";
  /**
   * User ID (Ethereum account address)
   */
...
export interface Community_homepage_resources_ExternalLinkDTO_comments_content {
  __typename: "CommentDTO";
  /**
   * Comment author (full profile)
   */
  author: Community_homepage_resources_ExternalLinkDTO_comments_content_author;
  /**
   * Date the comment was published
   */
  posted: any;
...
export interface Community_homepage_resources_ExternalLinkDTO_comments {
   ...
   * Returns the page content.
   */
  content: (Community_homepage_resources_ExternalLinkDTO_comments_content | null)[];
  /**
   * Number of total pages.
   */
  totalPages: number;
...
export interface Community_homepage_resources_ExternalLinkDTO_voteResult {
  __typename: "VoteResultDTO";
  /**
   * Vote sum: Sum of the vote (-1,+1,+1=+1)
   */
...
export interface Community_homepage_resources_ExternalLinkDTO {
  __typename: "ExternalLinkDTO";
  /**
   * External link ID
   */
  id: string;
  resourceIdentifier: Community_homepage_resources_ExternalLinkDTO_resourceIdentifier | null;
  /**
   ...
   */
  owner: Community_homepage_resources_ExternalLinkDTO_owner | null;
  /**
   * External link submitter (full profile)
   */
  submitter: Community_homepage_resources_ExternalLinkDTO_submitter;
  /**
   * The link url
   */
  url: Community_homepage_resources_ExternalLinkDTO_url;
  /**
   * The link title
   */
  linkTitle: Community_homepage_resources_ExternalLinkDTO_linkTitle;
  /**
   * The description of the link, obtained via metadata
   */
  linkDescription: Community_homepage_resources_ExternalLinkDTO_linkDescription | null;
  /**
   * The user input summary of the link
   */
  summary: Community_homepage_resources_ExternalLinkDTO_summary | null;
  /**
   * Link attributes
   */
   ...
   */
  authorName: Community_homepage_resources_ExternalLinkDTO_authorName;
  /**
   * Get a paginated list of comments for this external link
   */
  comments: Community_homepage_resources_ExternalLinkDTO_comments;
  /**
   * The link content author
   */
   ...
   */
  voteResult: Community_homepage_resources_ExternalLinkDTO_voteResult;
}
...
export interface Community_homepage_resources_CollectionDTO_sections_resources_ArticleDTO_resourceIdentifier {
  __typename: "ResourceIdentifier";
  /**
   * Resource ID
   */
...
export interface Community_homepage_resources_CollectionDTO_sections_resources_ArticleDTO_contributors_articles {
  __typename: "ResponsePage_ArticleDTO";
  /**
   * Total amount of elements.
   */
...
export interface Community_homepage_resources_CollectionDTO_sections_resources_ArticleDTO_contributors_collections {
  __typename: "ResponsePage_CollectionDTO";
  /**
   * Total amount of elements.
   */
...
export interface Community_homepage_resources_CollectionDTO_sections_resources_ArticleDTO_contributors_links {
  __typename: "ResponsePage_ExternalLinkDTO";
  /**
   * Total amount of elements.
   */
...
export interface Community_homepage_resources_CollectionDTO_sections_resources_ArticleDTO_contributors_communities_community {
  __typename: "CommunityDTO";
  /**
   * Community ID
   */
...
export interface Community_homepage_resources_CollectionDTO_sections_resources_ArticleDTO_contributors_communities {
  __typename: "MemberRoleCommunityDTO";
  /**
   * Community
   */
  community: Community_homepage_resources_CollectionDTO_sections_resources_ArticleDTO_contributors_communities_community;
}

export interface Community_homepage_resources_CollectionDTO_sections_resources_ArticleDTO_contributors {
  __typename: "PublicUserDTO";
  /**
   * User ID (Ethereum account address)
   */
   ...
   * This operation can only be performed by logged user
   */
  articles: Community_homepage_resources_CollectionDTO_sections_resources_ArticleDTO_contributors_articles;
  /**
   * Returns a page of CollectionDTO owned by this PublicUserDTO.
   * This operation can only be performed by logged user
   */
  collections: Community_homepage_resources_CollectionDTO_sections_resources_ArticleDTO_contributors_collections;
  /**
   * Returns a page of ExternalLinkDTO owned by this PublicUserDTO.
   * This operation can only be performed by logged user
   */
  links: Community_homepage_resources_CollectionDTO_sections_resources_ArticleDTO_contributors_links;
  /**
   * Get communities the user is member of mapped by role
   */
  communities: (Community_homepage_resources_CollectionDTO_sections_resources_ArticleDTO_contributors_communities | null)[];
}

export interface Community_homepage_resources_CollectionDTO_sections_resources_ArticleDTO_voteResult {
  __typename: "VoteResultDTO";
  /**
   * Vote sum: Sum of the vote (-1,+1,+1=+1)
   */
...
export interface Community_homepage_resources_CollectionDTO_sections_resources_ArticleDTO_author {
  __typename: "PublicUserDTO";
  /**
   * User ID (Ethereum account address)
   */
...
export interface Community_homepage_resources_CollectionDTO_sections_resources_ArticleDTO_owner_PublicUserDTO {
  __typename: "PublicUserDTO";
  /**
   * User ID (Ethereum account address)
   */
   ...
   */
  avatar: string | null;
  resourceIdentifier: Community_homepage_resources_CollectionDTO_sections_resources_ArticleDTO_owner_PublicUserDTO_resourceIdentifier | null;
}

export interface Community_homepage_resources_CollectionDTO_sections_resources_ArticleDTO_owner_CommunityDTO_resourceIdentifier {
  __typename: "ResourceIdentifier";
  /**
   * Resource ID
   */
...
export interface Community_homepage_resources_CollectionDTO_sections_resources_ArticleDTO_owner_CommunityDTO {
  __typename: "CommunityDTO";
  /**
   * Community ID
   */
   ...
   */
  avatar: string | null;
  resourceIdentifier: Community_homepage_resources_CollectionDTO_sections_resources_ArticleDTO_owner_CommunityDTO_resourceIdentifier | null;
}

export type Community_homepage_resources_CollectionDTO_sections_resources_ArticleDTO_owner = Community_homepage_resources_CollectionDTO_sections_resources_ArticleDTO_owner_ArticleDTO | Community_homepage_resources_CollectionDTO_sections_resources_ArticleDTO_owner_PublicUserDTO | Community_homepage_resources_CollectionDTO_sections_resources_ArticleDTO_owner_CommunityDTO;

export interface Community_homepage_resources_CollectionDTO_sections_resources_ArticleDTO_comments_content_author {
  __typename: "PublicUserDTO";
  /**
   * User ID (Ethereum account address)
   */
...
export interface Community_homepage_resources_CollectionDTO_sections_resources_ArticleDTO_comments_content {
  __typename: "CommentDTO";
  /**
   * Comment author (full profile)
   */
...
export interface Community_homepage_resources_CollectionDTO_sections_resources_ArticleDTO_comments {
   ...
   * Returns the page content.
   */
  content: (Community_homepage_resources_CollectionDTO_sections_resources_ArticleDTO_comments_content | null)[];
  /**
   * Number of total pages.
   */
  totalPages: number;
...
export interface Community_homepage_resources_CollectionDTO_sections_resources_ArticleDTO {
  __typename: "ArticleDTO";
  /**
   * NFTs associated with this article
   */
  associatedNfts: (Community_homepage_resources_CollectionDTO_sections_resources_ArticleDTO_associatedNfts | null)[] | null;
  resourceIdentifier: Community_homepage_resources_CollectionDTO_sections_resources_ArticleDTO_resourceIdentifier | null;
  /**
   * Returns a list of contributors (PublicUserDTO) for this ArticleDTO
   * This operation can only be performed by logged user
   */
  contributors: (Community_homepage_resources_CollectionDTO_sections_resources_ArticleDTO_contributors | null)[];
  /**
   * Check if the article was already read by the current user
   */
  isRead: boolean;
   ...
   * Get vote result for the article
   */
  voteResult: Community_homepage_resources_CollectionDTO_sections_resources_ArticleDTO_voteResult;
  /**
   * Article author (full profile)
   */
  author: Community_homepage_resources_CollectionDTO_sections_resources_ArticleDTO_author;
  /**
   * load the article owner (user or community resource type)
   */
  owner: Community_homepage_resources_CollectionDTO_sections_resources_ArticleDTO_owner | null;
  /**
   * Get a paginated list of comments for this article
   */
  comments: Community_homepage_resources_CollectionDTO_sections_resources_ArticleDTO_comments;
  /**
   * The comment describing this version update of the article
   */
  updateComment: string | null;
...
export interface Community_homepage_resources_CollectionDTO_sections_resources_ExternalLinkDTO_resourceIdentifier {
  __typename: "ResourceIdentifier";
  /**
   * Resource type
   */
...
export interface Community_homepage_resources_CollectionDTO_sections_resources_ExternalLinkDTO_owner_PublicUserDTO {
  __typename: "PublicUserDTO";
  /**
   * User ID (Ethereum account address)
   */
   ...
   */
  avatar: string | null;
  resourceIdentifier: Community_homepage_resources_CollectionDTO_sections_resources_ExternalLinkDTO_owner_PublicUserDTO_resourceIdentifier | null;
}

export interface Community_homepage_resources_CollectionDTO_sections_resources_ExternalLinkDTO_owner_CommunityDTO_resourceIdentifier {
  __typename: "ResourceIdentifier";
  /**
   * Resource ID
   */
...
export interface Community_homepage_resources_CollectionDTO_sections_resources_ExternalLinkDTO_owner_CommunityDTO {
  __typename: "CommunityDTO";
  /**
   * Community ID
   */
   ...
   */
  avatar: string | null;
  resourceIdentifier: Community_homepage_resources_CollectionDTO_sections_resources_ExternalLinkDTO_owner_CommunityDTO_resourceIdentifier | null;
}

export type Community_homepage_resources_CollectionDTO_sections_resources_ExternalLinkDTO_owner = Community_homepage_resources_CollectionDTO_sections_resources_ExternalLinkDTO_owner_ArticleDTO | Community_homepage_resources_CollectionDTO_sections_resources_ExternalLinkDTO_owner_PublicUserDTO | Community_homepage_resources_CollectionDTO_sections_resources_ExternalLinkDTO_owner_CommunityDTO;

export interface Community_homepage_resources_CollectionDTO_sections_resources_ExternalLinkDTO_submitter {
  __typename: "PublicUserDTO";
  /**
   * User ID (Ethereum account address)
   */
...
export interface Community_homepage_resources_CollectionDTO_sections_resources_ExternalLinkDTO_url {
  __typename: "ExternalLinkField_String";
  /**
   * The field value
   */
...
export interface Community_homepage_resources_CollectionDTO_sections_resources_ExternalLinkDTO_linkTitle {
  __typename: "ExternalLinkField_String";
  /**
   * The field value
   */
...
export interface Community_homepage_resources_CollectionDTO_sections_resources_ExternalLinkDTO_linkDescription {
  __typename: "ExternalLinkField_String";
  /**
   * The field value
   */
...
export interface Community_homepage_resources_CollectionDTO_sections_resources_ExternalLinkDTO_summary {
  __typename: "ExternalLinkField_String";
  /**
   * The field value
   */
...
export interface Community_homepage_resources_CollectionDTO_sections_resources_ExternalLinkDTO_authorName {
  __typename: "ExternalLinkField_String";
  /**
   * The field value
   */
...
export interface Community_homepage_resources_CollectionDTO_sections_resources_ExternalLinkDTO_comments_content_author {
  __typename: "PublicUserDTO";
  /**
   * User ID (Ethereum account address)
   */
...
export interface Community_homepage_resources_CollectionDTO_sections_resources_ExternalLinkDTO_comments_content {
  __typename: "CommentDTO";
  /**
   * Comment author (full profile)
   */
  author: Community_homepage_resources_CollectionDTO_sections_resources_ExternalLinkDTO_comments_content_author;
  /**
   * Date the comment was published
   */
  posted: any;
...
export interface Community_homepage_resources_CollectionDTO_sections_resources_ExternalLinkDTO_comments {
   ...
   * Returns the page content.
   */
  content: (Community_homepage_resources_CollectionDTO_sections_resources_ExternalLinkDTO_comments_content | null)[];
  /**
   * Number of total pages.
   */
  totalPages: number;
...
export interface Community_homepage_resources_CollectionDTO_sections_resources_ExternalLinkDTO_voteResult {
  __typename: "VoteResultDTO";
  /**
   * Vote sum: Sum of the vote (-1,+1,+1=+1)
   */
...
export interface Community_homepage_resources_CollectionDTO_sections_resources_ExternalLinkDTO {
  __typename: "ExternalLinkDTO";
  /**
   * External link ID
   */
  id: string;
  resourceIdentifier: Community_homepage_resources_CollectionDTO_sections_resources_ExternalLinkDTO_resourceIdentifier | null;
  /**
   * The date that this external link was created
   */
  dateCreated: any;
   ...
   * load the external link owner (user or community resource type)
   */
  owner: Community_homepage_resources_CollectionDTO_sections_resources_ExternalLinkDTO_owner | null;
  /**
   * External link submitter (full profile)
   */
  submitter: Community_homepage_resources_CollectionDTO_sections_resources_ExternalLinkDTO_submitter;
  /**
   * The link url
   */
  url: Community_homepage_resources_CollectionDTO_sections_resources_ExternalLinkDTO_url;
  /**
   * The link title
   */
  linkTitle: Community_homepage_resources_CollectionDTO_sections_resources_ExternalLinkDTO_linkTitle;
  /**
   * The description of the link, obtained via metadata
   */
  linkDescription: Community_homepage_resources_CollectionDTO_sections_resources_ExternalLinkDTO_linkDescription | null;
  /**
   * The user input summary of the link
   */
  summary: Community_homepage_resources_CollectionDTO_sections_resources_ExternalLinkDTO_summary | null;
  /**
   * Link attributes
   */
  linkAttributes: any | null;
   ...
   * The link content author
   */
  authorName: Community_homepage_resources_CollectionDTO_sections_resources_ExternalLinkDTO_authorName;
  /**
   * Get a paginated list of comments for this external link
   */
  comments: Community_homepage_resources_CollectionDTO_sections_resources_ExternalLinkDTO_comments;
  /**
   * The link content author
   */
  authorSocial: any | null;
   ...
   * Get vote result for the external link
   */
  voteResult: Community_homepage_resources_CollectionDTO_sections_resources_ExternalLinkDTO_voteResult;
}

export type Community_homepage_resources_CollectionDTO_sections_resources = Community_homepage_resources_CollectionDTO_sections_resources_PublicUserDTO | Community_homepage_resources_CollectionDTO_sections_resources_ArticleDTO | Community_homepage_resources_CollectionDTO_sections_resources_ExternalLinkDTO;
...
export interface Community_homepage_resources_CollectionDTO_sections {
   ...
   */
  resources: (Community_homepage_resources_CollectionDTO_sections_resources | null)[];
}
...
export type Community_homepage_resources = Community_homepage_resources_PublicUserDTO | Community_homepage_resources_ArticleDTO | Community_homepage_resources_ExternalLinkDTO | Community_homepage_resources_CollectionDTO;
...
export interface Community_approved_ExternalLinkDTO_resourceIdentifier {
  __typename: "ResourceIdentifier";
  /**
   * Resource type
   */
...
export interface Community_approved_ExternalLinkDTO_owner_ArticleDTO {
  __typename: "ArticleDTO" | "CollectionDTO" | "CommunityInvitationDTO" | "CommunityMemberDTO" | "ExternalLinkDTO" | "CommentDTO" | "SeriesDTO" | "UserDTO" | "TemplateDTO" | "SearchResultDTO" | "CuratedListDTO";
}

export interface Community_approved_ExternalLinkDTO_owner_PublicUserDTO_resourceIdentifier {
  __typename: "ResourceIdentifier";
  /**
   * Resource ID
   */
...
export interface Community_approved_ExternalLinkDTO_owner_PublicUserDTO {
  __typename: "PublicUserDTO";
  /**
   * User ID (Ethereum account address)
   */
   ...
   */
  avatar: string | null;
  resourceIdentifier: Community_approved_ExternalLinkDTO_owner_PublicUserDTO_resourceIdentifier | null;
}

export interface Community_approved_ExternalLinkDTO_owner_CommunityDTO_resourceIdentifier {
  __typename: "ResourceIdentifier";
  /**
   * Resource ID
   */
...
export interface Community_approved_ExternalLinkDTO_owner_CommunityDTO {
  __typename: "CommunityDTO";
  /**
   * Community ID
   */
   ...
   */
  avatar: string | null;
  resourceIdentifier: Community_approved_ExternalLinkDTO_owner_CommunityDTO_resourceIdentifier | null;
}

export type Community_approved_ExternalLinkDTO_owner = Community_approved_ExternalLinkDTO_owner_ArticleDTO | Community_approved_ExternalLinkDTO_owner_PublicUserDTO | Community_approved_ExternalLinkDTO_owner_CommunityDTO;

export interface Community_approved_ExternalLinkDTO_submitter {
  __typename: "PublicUserDTO";
  /**
   * User ID (Ethereum account address)
   */
...
export interface Community_approved_ExternalLinkDTO_url {
  __typename: "ExternalLinkField_String";
  /**
   * The field value
   */
...
export interface Community_approved_ExternalLinkDTO_linkTitle {
  __typename: "ExternalLinkField_String";
  /**
   * The field value
   */
...
export interface Community_approved_ExternalLinkDTO_linkDescription {
  __typename: "ExternalLinkField_String";
  /**
   * The field value
   */
...
export interface Community_approved_ExternalLinkDTO_summary {
  __typename: "ExternalLinkField_String";
  /**
   * The field value
   */
...
export interface Community_approved_ExternalLinkDTO_authorName {
  __typename: "ExternalLinkField_String";
  /**
   * The field value
   */
...
export interface Community_approved_ExternalLinkDTO_comments_content_author {
  __typename: "PublicUserDTO";
  /**
   * User ID (Ethereum account address)
   */
...
export interface Community_approved_ExternalLinkDTO_comments_content {
  __typename: "CommentDTO";
  /**
   * Comment author (full profile)
   */
  author: Community_approved_ExternalLinkDTO_comments_content_author;
  /**
   * Date the comment was published
   */
  posted: any;
...
export interface Community_approved_ExternalLinkDTO_comments {
  __typename: "ResponsePage_CommentDTO";
  /**
   * Returns the page content.
   */
  content: (Community_approved_ExternalLinkDTO_comments_content | null)[];
  /**
   * Number of total pages.
   */
  totalPages: number;
...
export interface Community_approved_ExternalLinkDTO_voteResult {
  __typename: "VoteResultDTO";
  /**
   * Vote sum: Sum of the vote (-1,+1,+1=+1)
   */
...
export interface Community_approved_ExternalLinkDTO {
  __typename: "ExternalLinkDTO";
  /**
   * External link ID
   */
  id: string;
  resourceIdentifier: Community_approved_ExternalLinkDTO_resourceIdentifier | null;
  /**
   * The date that this external link was created
   */
  dateCreated: any;
   ...
   * load the external link owner (user or community resource type)
   */
  owner: Community_approved_ExternalLinkDTO_owner | null;
  /**
   * External link submitter (full profile)
   */
  submitter: Community_approved_ExternalLinkDTO_submitter;
  /**
   * The link url
   */
  url: Community_approved_ExternalLinkDTO_url;
  /**
   * The link title
   */
  linkTitle: Community_approved_ExternalLinkDTO_linkTitle;
  /**
   * The description of the link, obtained via metadata
   */
  linkDescription: Community_approved_ExternalLinkDTO_linkDescription | null;
  /**
   * The user input summary of the link
   */
  summary: Community_approved_ExternalLinkDTO_summary | null;
  /**
   * Link attributes
   */
  linkAttributes: any | null;
   ...
   * The link content author
   */
  authorName: Community_approved_ExternalLinkDTO_authorName;
  /**
   * Get a paginated list of comments for this external link
   */
  comments: Community_approved_ExternalLinkDTO_comments;
  /**
   * The link content author
   */
  authorSocial: any | null;
   ...
   * Get vote result for the external link
   */
  voteResult: Community_approved_ExternalLinkDTO_voteResult;
}
...
export interface Community_approved_CollectionDTO_sections_resources_ExternalLinkDTO_voteResult {
  __typename: "VoteResultDTO";
  /**
   * Vote sum: Sum of the vote (-1,+1,+1=+1)
   */
...
export interface Community_approved_CollectionDTO_sections_resources_ExternalLinkDTO {
   ...
   * Get vote result for the external link
   */
  voteResult: Community_approved_CollectionDTO_sections_resources_ExternalLinkDTO_voteResult;
}
...
export type Community_approved = Community_approved_PublicUserDTO | Community_approved_ArticleDTO | Community_approved_ExternalLinkDTO | Community_approved_CollectionDTO;
...
export interface Community_pending_ExternalLinkDTO_resourceIdentifier {
  __typename: "ResourceIdentifier";
  /**
   * Resource type
   */
...
export interface Community_pending_ExternalLinkDTO_owner_ArticleDTO {
  __typename: "ArticleDTO" | "CollectionDTO" | "CommunityInvitationDTO" | "CommunityMemberDTO" | "ExternalLinkDTO" | "CommentDTO" | "SeriesDTO" | "UserDTO" | "TemplateDTO" | "SearchResultDTO" | "CuratedListDTO";
}

export interface Community_pending_ExternalLinkDTO_owner_PublicUserDTO_resourceIdentifier {
  __typename: "ResourceIdentifier";
  /**
   * Resource ID
   */
...
export interface Community_pending_ExternalLinkDTO_owner_PublicUserDTO {
  __typename: "PublicUserDTO";
  /**
   * User ID (Ethereum account address)
   */
   ...
   */
  avatar: string | null;
  resourceIdentifier: Community_pending_ExternalLinkDTO_owner_PublicUserDTO_resourceIdentifier | null;
}

export interface Community_pending_ExternalLinkDTO_owner_CommunityDTO_resourceIdentifier {
  __typename: "ResourceIdentifier";
  /**
   * Resource ID
   */
...
export interface Community_pending_ExternalLinkDTO_owner_CommunityDTO {
  __typename: "CommunityDTO";
  /**
   * Community ID
   */
   ...
   */
  avatar: string | null;
  resourceIdentifier: Community_pending_ExternalLinkDTO_owner_CommunityDTO_resourceIdentifier | null;
}

export type Community_pending_ExternalLinkDTO_owner = Community_pending_ExternalLinkDTO_owner_ArticleDTO | Community_pending_ExternalLinkDTO_owner_PublicUserDTO | Community_pending_ExternalLinkDTO_owner_CommunityDTO;

export interface Community_pending_ExternalLinkDTO_submitter {
  __typename: "PublicUserDTO";
  /**
   * User ID (Ethereum account address)
   */
...
export interface Community_pending_ExternalLinkDTO_url {
  __typename: "ExternalLinkField_String";
  /**
   * The field value
   */
...
export interface Community_pending_ExternalLinkDTO_linkTitle {
  __typename: "ExternalLinkField_String";
  /**
   * The field value
   */
...
export interface Community_pending_ExternalLinkDTO_linkDescription {
  __typename: "ExternalLinkField_String";
  /**
   * The field value
   */
...
export interface Community_pending_ExternalLinkDTO_summary {
  __typename: "ExternalLinkField_String";
  /**
   * The field value
   */
...
export interface Community_pending_ExternalLinkDTO_authorName {
  __typename: "ExternalLinkField_String";
  /**
   * The field value
   */
...
export interface Community_pending_ExternalLinkDTO_comments_content_author {
  __typename: "PublicUserDTO";
  /**
   * User ID (Ethereum account address)
   */
...
export interface Community_pending_ExternalLinkDTO_comments_content {
  __typename: "CommentDTO";
  /**
   * Comment author (full profile)
   */
  author: Community_pending_ExternalLinkDTO_comments_content_author;
  /**
   * Date the comment was published
   */
  posted: any;
...
export interface Community_pending_ExternalLinkDTO_comments {
  __typename: "ResponsePage_CommentDTO";
  /**
   * Returns the page content.
   */
  content: (Community_pending_ExternalLinkDTO_comments_content | null)[];
  /**
   * Number of total pages.
   */
  totalPages: number;
...
export interface Community_pending_ExternalLinkDTO_voteResult {
  __typename: "VoteResultDTO";
  /**
   * Vote sum: Sum of the vote (-1,+1,+1=+1)
   */
...
export interface Community_pending_ExternalLinkDTO {
  __typename: "ExternalLinkDTO";
  /**
   * External link ID
   */
  id: string;
  resourceIdentifier: Community_pending_ExternalLinkDTO_resourceIdentifier | null;
  /**
   * The date that this external link was created
   */
  dateCreated: any;
   ...
   * load the external link owner (user or community resource type)
   */
  owner: Community_pending_ExternalLinkDTO_owner | null;
  /**
   * External link submitter (full profile)
   */
  submitter: Community_pending_ExternalLinkDTO_submitter;
  /**
   * The link url
   */
  url: Community_pending_ExternalLinkDTO_url;
  /**
   * The link title
   */
  linkTitle: Community_pending_ExternalLinkDTO_linkTitle;
  /**
   * The description of the link, obtained via metadata
   */
  linkDescription: Community_pending_ExternalLinkDTO_linkDescription | null;
  /**
   * The user input summary of the link
   */
  summary: Community_pending_ExternalLinkDTO_summary | null;
  /**
   * Link attributes
   */
  linkAttributes: any | null;
   ...
   * The link content author
   */
  authorName: Community_pending_ExternalLinkDTO_authorName;
  /**
   * Get a paginated list of comments for this external link
   */
  comments: Community_pending_ExternalLinkDTO_comments;
  /**
   * The link content author
   */
  authorSocial: any | null;
   ...
   * Get vote result for the external link
   */
  voteResult: Community_pending_ExternalLinkDTO_voteResult;
}
...
export interface Community_pending_CollectionDTO_sections_resources_ExternalLinkDTO_voteResult {
  __typename: "VoteResultDTO";
  /**
   * Vote sum: Sum of the vote (-1,+1,+1=+1)
   */
...
export interface Community_pending_CollectionDTO_sections_resources_ExternalLinkDTO {
   ...
   * Get vote result for the external link
   */
  voteResult: Community_pending_CollectionDTO_sections_resources_ExternalLinkDTO_voteResult;
}
...
export type Community_pending = Community_pending_PublicUserDTO | Community_pending_ArticleDTO | Community_pending_ExternalLinkDTO | Community_pending_CollectionDTO;
