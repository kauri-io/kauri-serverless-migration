...
import { DialogTitle, DialogContent, DialogContentText, DialogActions, Typography, IconButton, InputBase } from '@material-ui/core';
    ...
    return (
      <Dialog 
        ...
        <DialogContent dividers className={classes.container}> 
          <DialogContentText id="alert-dialog-description"  className={classes.body}>
                        ...
                        <div className={classes.left}>
                          ...
                          <CardDetails 
                            user={{
                              ...
                              username: link.submitter.username || "", 
                              name: link.submitter.name || "", 
                              avatar: link.submitter.avatar || ""}}
        ...
        <DialogActions className={classes.container}>
          <Typography variant="subtitle1" className={classes.title}>{`${selected.length} selected`}</Typography>
          <Button
              color="primary"
              variant="text"
              onClick={handleClose}
