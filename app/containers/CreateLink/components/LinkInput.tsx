...
const sampleLink = {
    ...
    description:
        'TLDR: A smart contract is a computer protocol intended to digitally facilitate, verify, or enforce the negotiation or performance of a contract. Smart contracts allow the performan',
    attributes: {
        background_image:
            'https://pbs.twimg.com/ad_img/1128053087166287872/kQhsjPBf?format=jpg&name=small',
    },
    authorName: 'Greg',
